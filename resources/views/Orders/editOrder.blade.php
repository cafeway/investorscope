...
<!-- components-tab.html  Tue, 07 Jan 2020 03:37:12 GMT -->
<head>
<meta charset="UTF-8">
<meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
<title>Components &rsaquo; Tab &mdash; CodiePie</title>
...
{{--
                ...
                <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="btn btn-warning btn-lg btn-block btn-icon-split"><i class="fa fa-sign-out"></i>Logout</button>
                    </form>
                </div>
            </aside>
        </div>
        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="section-body">
                    <h2 class="section-title">{{ $order->ordertitle }}</h2>

                    <p class="section-lead">{{ $order->id }}</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Order Details</a></li>
                                        {{-- <li class="nav-item"><a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Files</a></li> --}}
                                        <li class="nav-item"><a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Comments & Regards</a></li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <div class="col-12 col-md-4 col-lg-8">
                                                <div class="pricing">
                                                    <div class="pricing-title">{{ $order->ordertitle }}</div>
                                                    <div class="pricing-padding">
                                                        <div class="pricing-price">
                                                            <div>${{ $order->budget }}</div>
                                                            <div><small>budget</small></div>
                                                        </div>
                                                        <div class="pricing-details">
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary"><i class="fa fa-database"></i></div>
                                                                <div class="pricing-item-label"><b>Type:</b> {{ $order->requesttype }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary"><i class="fas fa-calendar"></i></div>
                                                                <div class="pricing-item-label"><b>Created At:</b> {{ $order->created_at }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary"><i class="fas fa-check"></i></div>
                                                                <div class="pricing-item-label"><b>Deadline:</b> {{ $order->duedate }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary"><i class="fas fa-star"></i></div>
                                                                <div class="pricing-item-label badge badge-primary"><b>Status:</b> {{ $order->status }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary text-white"><i class="fas fa-university"></i></div>
                                                                <div class="pricing-item-label"><b>Academic Level:</b>{{ $order->academiclevel }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary text-white"><i class="fa fa-book"></i></div>
                                                                <div class="pricing-item-label"><b>Request Type:</b>{{ $order->requesttype }}</div>
                                                            </div>
                                                            <div class="pricing-item">
                                                                <div class="pricing-item-icon bg-primary text-white"><i class="fa fa-paper-plane"></i></div>
                                                                <div class="pricing-item-label"><b>Comments & Instructions</b>{{ $order->comments }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pricing-cta">
                                                        <a href="#">Verify order <i class="fas fa-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="section-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        <h4>Upload Zip Files here</h4>
                                                                    </div>
                                                                    <div class="card-body">
                                                                        <form method="POST" class="dropzone" id="mydropzone" action="{{ route('upload') }}" enctype="multipart/form-data">
                                                                            @csrf
                                                                            <div class="fallback">
