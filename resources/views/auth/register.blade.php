...
<title>Register &mdash; Trident</title>
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    <div class="login-brand">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="purple" class="bi bi-person-circle" viewBox="0 0 16 16">
                            ...
                            <form method="post" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input id="first_name" value="{{ old('first_name') }}" type="text" class="form-control" name="first_name" autofocus required>
                                        @error('first_name')
                                    ...
                                    <div class="form-group col-6">
                                        <label for="last_name" value="{{ old('last_name') }}">Last Name</label>
                                ...
                                <div class="form-group">
                                   ...
                                   @error('email')
                                       <small class="text-danger">The address you chose is in use</small>
                                   @enderror
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="phone" class="d-block" value="old('phonenumber')">PhoneNumber</label>
                                        <input id="phone" type="text" class="form-control pwstrength" data-indicator="pwindicator" name="phonenumber" required>
                                        @error('phonenumber')
                                        <small class="text-danger">This phonenumbe is in use by another account</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="username" class="d-block" value="old('username')">Username</label>
                    ...
                    <div class="simple-footer">
                        Copyright &copyright Of Trident 2020
                    </div>
                </div>
            </div>
        </div>
