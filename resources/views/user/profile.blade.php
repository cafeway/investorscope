...
{{--
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="{{ route('fund') }}">Fund Account</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <input type="text" class="form-control" value="{{ Auth::user()->first_name }}" readonly required="">
                                                <div class="invalid-feedback">Please fill in the first name</div>
                                            </div>
                                            <div class="form-group col-md-6 col-12">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control"  value="{{ Auth::user()->last_name}}" readonly  required="required">
                                                <div class="invalid-feedback">Please fill in the first name</div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 col-12">
                                                <label>Phone</label>
                                                <input type="tel" class="form-control" value="{{ Auth::user()->phonenumber }}">
                                            </div>
                                            <div class="form-group col-md-4 col-12">
                                                <label>Username</label>
                                                <input type="tel" class="form-control" value="{{ Auth::user()->username }}">
                                            </div>
                                        </div>
                                        <div class="row">
